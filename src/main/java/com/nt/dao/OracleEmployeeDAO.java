...
public class OracleEmployeeDAO implements IEmployeeDAO {
	...
	private static final String GET_EMPS_BY_JOBS = "SELECT EMPNO,ENAME,JOB,SAL,DEPTNO FROM EMP WHERE JOB IN(?,?,?) ORDER BY JOB"; 
	...
	public OracleEmployeeDAO() {
		super();
		System.out.println("OracleEmployeeDAO::0-Param Constructor.");
	}
